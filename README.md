...
<a href="https://fertilityawareness.wowen.tech/">
    <img src="https://img.shields.io/badge/Web%20App%20Version-web--v1.1.0--alpha-yellow" alt="Web App Version: web-v1.1.0-alpha">
</a>
<a href="https://fertilityawareness.wowen.tech/">
    <img src="https://img.shields.io/badge/Mobile%20App%20iOS%20Version-app--ios--v1.0.0--alpha-yellow" alt="Mobile App iOS Version: app-ios-v1.0.0-alpha">
</a>
  <a href="https://fertilityawareness.wowen.tech/">
    <img src="https://img.shields.io/badge/Mobile%20App%20Android%20Version-Planned-yellow" alt="Mobile App Android Version: Planned">
</a>
<a href="#">
...
<h1 align="center">Fertility Awareness [Web App Frontend + Mobile App]</h1>
<h3 align="center">Fertility Awareness Project Repos:</h3>
<p align="center">
<p align="center">
😀 You are here: Web App Frontend + Mobile App
  <br>
...
- [Mobile App (iOS)](#mobile-app-ios-1)
  - [Developer Documentation: Technical Architecture and Stack Overview](#developer-documentation-technical-architecture-and-stack-overview-1)
    - [Files](#files)
- [Mobile App (Android)](#mobile-app-android-1)
  - [Developer Documentation: Technical Architecture and Stack Overview](#developer-documentation-technical-architecture-and-stack-overview-2)
    - [Files](#files-1)
...
In most cases, changes should never be directly deployed to our `main` branch, which serves as the production site/main branch/environment. Instead, commit and deploy your changes to our staging branch first, and if approved it will be merged and synced into our `main` branch. For the Web App ([fertilityawareness.wowen.tech](https://fertilityawareness.wowen.tech/)), the staging branch is named `staging` and can be accessed at [https://staging--fertilityawareness.netlify.app/](https://staging--fertilityawareness.netlify.app/).
...
- **Branch Deploys:** `staging`. *Note that `staging-app-ios` and `staging-app-android` are not included here, those branches are intended for the mobile apps. Netlify is ignoring staging-app-ios and staging-app-android; it won't make websites from them*.
- **Deploy Previews:** `Any pull request against your production branch / branch deploy branches`

## Mobile App (iOS)
- Deployment and staging information will be updated.
- Files are stored at https://github.com/WOWEN-DEV/fertilityawareness/tree/main/app/ios
- Staging branch: `staging-app-ios`

## Mobile App (Android)
- Deployment and staging information will be updated.
- Files are stored at https://github.com/WOWEN-DEV/fertilityawareness/tree/main/app/android
- Staging branch: `staging-app-android`

<br>

# Changelogs
These changelogs provide a high-level overview of the changes made in each version of the software:
- [Web App Changelog](https://github.com/WOWEN-DEV/fertilityawareness/blob/main/CHANGELOG-WEB.md)
- [Mobile App (iOS) Changelog](https://github.com/WOWEN-DEV/fertilityawareness/blob/main/CHANGELOG-APP-IOS.md)
- [Mobile App (Android) Changelog](https://github.com/WOWEN-DEV/fertilityawareness/blob/main/CHANGELOG-APP-ANDROID.md)

<br>

# Roadmap

[The Roadmap Document](https://github.com/WOWEN-DEV/fertilityawareness/blob/main/ROADMAP.md) provides a comprehensive overview, detailing the development trajectory, upcoming releases, and features that are in the pipeline for Fertility Awareness. Below, you'll find a succinct summary highlighting key vitals and the current status of the project.

[Web App Version](https://github.com/WOWEN-DEV/fertilityawareness)
- **`web-v1.0.0-alpha` > `web-v1.1.0-alpha` – Current Version:** ![Released](https://img.shields.io/badge/Status-Released-brightgreen)
- **`web-v2.0.0-alpha` – Alpha Upgrade:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
- **`web-v3.0.0-beta` – Beta Upgrade:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
- **`web-v4.0.0-beta` – Beta Upgrade:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
- **`web-v5.0.0-cervix` – Release Version:** ![Planned](https://img.shields.io/badge/Status-Planned-red)

[Mobile App Version (iOS)](https://github.com/WOWEN-DEV/fertilityawareness-app)
- **`app-ios-v1.0.0-alpha` – Current Version:** ![In Development](https://img.shields.io/badge/Status-In%20Development-yellow)
- **`app-ios-v2.0.0-alpha` – Alpha Upgrade:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
- **`app-ios-v3.0.0-beta` – Beta Upgrade:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
- **`app-ios-v4.0.0-beta` – Beta Upgrade:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
- **`app-ios-v5.0.0-cervix` – Release Version:** ![Planned](https://img.shields.io/badge/Status-Planned-red)

[Mobile App Version (Android)](https://github.com/WOWEN-DEV/fertilityawareness-app)
- **`app-android-v1.0.0-alpha` – Current Version:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
- **`app-android-v2.0.0-alpha` – Alpha Upgrade:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
- **`app-android-v3.0.0-beta` – Beta Upgrade:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
- **`app-android-v4.0.0-beta` – Beta Upgrade:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
- **`app-android-v5.0.0-cervix` – Release Version:** ![Planned](https://img.shields.io/badge/Status-Planned-red)
...
### Files
https://github.com/WOWEN-DEV/fertilityawareness/tree/main/app/ios
...
### Files
https://github.com/WOWEN-DEV/fertilityawareness/tree/main/app/android
